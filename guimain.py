...
class MyApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.statusBar().showMessage('버전0.2 업데이트내역: 파일 업로드 기능 추가')
    ...
    def second_window(self):
        window_2 = second_window.frXy_addr()
        window_2.exec_()
        
    def frAddr_xy_window(self):
        window_2 = second_window.frAddr_xy()
        window_2.exec_()   

    def frRoad_region_window(self):
        window_2 = second_window.frRoad_region()
        window_2.exec_()   
        
    def frRegion_road_window(self):
        window_2 = second_window.frRegion_road()
        window_2.exec_()   
